...
class STRGTransform(nn.Module):
    ...
    def __init__(self, min_size, max_size, image_mean, image_std):
        super(STRGTransform, self).__init__()
...
#        return (image - mean[:, None, None]) / std[:, None, None]
    ...
    def rpn_postprocess(self,
        ...
        if self.training:
            return result
        new_boxes = []
        for i, (boxes, im_s, o_im_s) in enumerate(zip(result, image_shapes, original_image_sizes)):
