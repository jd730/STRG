...
if __name__ == '__main__':
    ...
    train_csv_path = args.dir_path / 'something-something-v1-train.csv'
    val_csv_path = args.dir_path / 'something-something-v1-validation.csv'
    test_csv_path = args.dir_path / 'something-something-v1-test.csv'
...
#    test_csv_path = args.dir_path / 'test_videofolder.txt'
    ...
    convert_sthv1_csv_to_json(class_file_path, train_csv_path, val_csv_path,
